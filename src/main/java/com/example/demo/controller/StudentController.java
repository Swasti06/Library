...
public class StudentController {
	...
	@PostMapping("/student/returnBook")
	...
	@GetMapping("/student/getStudentDetails/{id}")
	public Student getStudDetails(@PathVariable int id) {
		return studentService.getStudentDetailsFromDB(id);
	}
